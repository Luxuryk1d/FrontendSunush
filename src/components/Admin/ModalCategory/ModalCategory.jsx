...
import { addCategory } from '@/redux/slices/categories/categories';

const ModalCategory = ({ showModal, setShowModal }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
              ...
              <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
                ...
                <div className='px-6 py-6 lg:px-8'>
                  <h3 className='mb-4 text-xl font-medium text-gray-900 dark:text-white'>
                    Введите название категории на трех языках
                  </h3>
                  <form
                    className='space-y-6'
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        required
                        {...register("rusTitle", { required: true })}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
                        required
                        {...register("kgTitle", { required: true })}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white'
                        required
                        {...register("engTitle", { required: true })}
                      />
                    </div>
